...
public class ScannerImage extends AppCompatActivity implements View.OnClickListener{

    public static final String UPLOAD_URL = "http://192.168.1.162/android/pharmacie/scannerImage.php";
